        ...
        <div class="card flex flex-col justify-center p-10 bg-white rounded-lg shadow-2xl">
          ...
          <div class="prod-info grid gap-10">
            <div class="flex flex-col md:flex-row justify-between items-center text-gray-900">
              ...
              <a href={`/product/${_id}`}>
                <button class="px-6 py-2 font-medium transition ease-in duration-200 uppercase rounded-full hover:bg-gray-800 hover:text-white border-2 border-gray-900 focus:outline-none">
                  See More
                </button>
              </a>
            </div>
